...
USAGE:
    ...
    $ vault404 search "error"  # Search for solutions
    $ vault404 export          # Export all data
    $ vault404 encrypt         # Enable encryption

    # Environment variables
    VAULT404_ENCRYPTED=true    # Enable encryption
    VAULT404_PASSWORD=xxx      # Encryption password
    VAULT404_COMMUNITY=true    # Enable community brain
