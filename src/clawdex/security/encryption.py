"""
Encryption Module for Claw-dex
...
class Encryptor:
    """
    AES-256 encryption for Claw-dex data.
    ...
    SALT_FILE = "clawdex.salt"
    KEY_FILE = "clawdex.key"
    ...
    def __init__(self, data_dir: Optional[Path] = None, password: Optional[str] = None):
        ...
        Args:
            data_dir: Directory for storing salt/key files (default: ~/.clawdex)
        ...
        self.data_dir = data_dir or Path.home() / ".clawdex"
