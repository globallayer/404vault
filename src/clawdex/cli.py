"""
Claw-dex Command Line Interface

Usage:
    clawdex stats           Show knowledge base statistics
    clawdex export [PATH]   Export all data to JSON
...
def cmd_purge(args: argparse.Namespace) -> int:
    """Delete all Claw-dex data."""
    if not args.confirm:
        print("\n⚠️  WARNING: This will permanently delete ALL Claw-dex data!")
...
def cmd_encrypt(args: argparse.Namespace) -> int:
    ...
    print("\n🔐 Enabling encryption for Claw-dex data...")
    ...
    print("\n✅ Encryption enabled!")
    print("   Set CLAWDEX_ENCRYPTED=true to enable on future runs.")
    if password:
        print("   Set CLAWDEX_PASSWORD to your password to unlock data.")
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="clawdex",
        description="Claw-dex: AI Coding Agent Memory",
