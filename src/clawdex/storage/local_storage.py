"""
Local Storage Backend for Claw-dex

Stores all data locally in ~/.clawdex/ with optional encryption.
...
ENCRYPTED_MARKER = b"CLAWDEX_ENCRYPTED:"


class LocalStorage:
    """
    Local file-based storage for Claw-dex.
