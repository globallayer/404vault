"""Recording tools for Claw-dex - log errors, decisions, and patterns with secret redaction"""
...
async def log_error_fix(
    ...
    """
    Log an error and its solution to Claw-dex.
...
async def log_decision(
    ...
    """
    Log an architectural decision to Claw-dex.
...
async def log_pattern(
    ...
    """
    Log a reusable pattern to Claw-dex.
