"""Querying tools for Claw-dex - find solutions, decisions, and patterns"""
...
COMMUNITY_ENABLED = os.environ.get("CLAWDEX_COMMUNITY", "").lower() in ("true", "1", "yes")
...
async def find_solution(
    ...
    """
    Find solutions for an error from Claw-dex.
    ...
    if not all_results:
        return {
            "found": False,
            "message": "No matching solutions found in Claw-dex",
            "solutions": [],
...
async def find_decision(
    ...
    """
    Find past decisions on a topic from Claw-dex.
...
async def find_pattern(
    ...
    """
    Find reusable patterns for a problem from Claw-dex.
