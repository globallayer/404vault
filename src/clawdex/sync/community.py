"""
Community Brain API Client for Claw-dex

Connects to the shared knowledge repository where verified solutions
from all Claw-dex users are aggregated.
...
API_KEY = os.environ.get("CLAWDEX_API_KEY", DEFAULT_ANON_KEY)
...
class CommunityBrain:
    """
    Client for the Claw-dex Community Brain.
