...
logger = logging.getLogger("clawdex")

# Create MCP server
server = Server("clawdex")
...
TOOLS = [
    ...
    Tool(
        name="log_error_fix",
        description="""Log an error and its solution to the Claw-dex.
...
Optional: error_type, stack_trace, file, line, code_change, files_modified,
    ...
    Tool(
        name="log_decision",
        description="""Log an architectural decision to the Claw-dex.
...
Optional: alternatives, pros, cons, deciding_factor, project, component, language, framework""",
    ...
    Tool(
        name="log_pattern",
        description="""Log a reusable pattern to the Claw-dex.
...
Optional: languages, frameworks, databases, scenarios, before_code, after_code, explanation""",
    ...
    Tool(
        name="find_solution",
        description="""Find solutions for an error from the Claw-dex.
...
Optional: project, language, framework, database, platform, category, limit""",
    ...
    Tool(
        name="find_decision",
        description="""Find past decisions on a topic from the Claw-dex.
...
Optional: project, component, limit""",
    ...
    Tool(
        name="find_pattern",
        description="""Find reusable patterns for a problem from the Claw-dex.
...
Required: record_id, success""",
    ...
    Tool(
        ...
        description="""Get statistics about the Claw-dex knowledge base.
...
def main():
    """Run the MCP server"""
    logger.info("Starting Claw-dex MCP Server...")
